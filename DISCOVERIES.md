...
| --- | ---: | --- | --- | --- |
| [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 143,358 | 2026-08-11 | GPL-3.0 | FULL Augment Code, Claude Code, Cluely, CodeBuddy, Comet, Cursor, Devin AI, Junie, Kiro, Leap.new, Lovable, Manus, NotionAI, Orchids.app, Perplexity, Poke, Qoder, Replit, Same.dev, Trae, Traycer AI, VSCode Agent, Warp.dev, Windsurf, Xcode, Z.ai Code, Dia &amp; v0. (And other Open Sourced) System Prompts, Internal Tools &amp; AI Models |
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | 17,051 | 2026-09-04 | Not declared | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / Cursor / Gemini-cli / CodeBuddy，多账号切换、配额监控、自动唤醒与多开实例管理。 🚀 Universal AI IDE account manager for Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / Cursor / Gemini-cli / CodeBuddy, with multi-account switching, quota monitoring, wake-up automation, and multi-insta |
| [SakuraByteCore/codexmate](https://github.com/SakuraByteCore/codexmate) | 342 | 2026-09-03 | Apache-2.0 | One dashboard for all your local AI coding agents. Switch providers, manage sessions, and orchestrate tasks across Codex, Claude Code, Gemini CLI, CodeBuddy Code, Pi, OpenCode, KiloCode, and OpenClaw. Zero cloud, local-first control plane. |
...
| [ylw1997/touchFish](https://github.com/ylw1997/touchFish) | 155 | 2026-09-04 | Non-standard / unrecognized | 一个在VScode、Cursor、Trae、CodeBuddy、Qorder、Antigravity编辑器的摸鱼工具,包含微信读书,x,小宇宙,bilibili,网易云音乐,qq音乐,知乎,小红书,微博,虎扑,nga,chiphell,v2es,linux.do,ithome等频道 |
...
| [PomeloR611/libtv-video-agent](https://github.com/PomeloR611/libtv-video-agent) | 43 | 2026-08-06 | MIT | LibTV 视频制作 Agent：用 LibTV CLI(Seedance 2.0) 把分镜做成短片的跨工具通用 Agent — 九宫格→clean→image2video→ffmpeg 终剪全流程 + prompt 铁律库 + 踩坑速查。支持 Claude Code/Codex/CodeBuddy。 |
...
| [squallopen/superpowers-zh-adapters](https://github.com/squallopen/superpowers-zh-adapters) | 37 | 2026-08-17 | MIT | 为 Cline、Codex、Claude Code、Droid、OpenCode、CodeBuddy 和 ZCode 提供 obra/superpowers 的中文友好适配，支持中文触发、中文文档输出和更稳的安装更新体验。 |
...
| [Tencent/LoopForge](https://github.com/Tencent/LoopForge) | 27 | 2026-09-01 | Non-standard / unrecognized | Resumable multi-agent development workflows for coding agents (CodeBuddy, Codex, Cursor, Claude Code). |
| [AlanHuang168/AI-Project-Workflow](https://github.com/AlanHuang168/AI-Project-Workflow) | 27 | 2026-07-22 | MIT | 一套面向 Cursor、Claude Code、Codex、Qoder、CodeBuddy、CatPaw、TRAE 以及其他 AI 编码助手的通用 AI 原生软件交付工作流。一份规范的 core/ 单一真相源、每个工具一层轻量适配、一个跟踪进度的状态文件,以及负责安装与校验的 CLI。 |
...
| [ycyliu/travel-planner-skill](https://github.com/ycyliu/travel-planner-skill) | 11 | 2026-03-19 | MIT | AI-powered travel guide generator skill for WorkBuddy/CodeBuddy. Xiaohongshu-first research + beautiful HTML output. |
