...
**40 curated repositories · 3 original Skills · 40 discovery candidates · weekly validation**
...
本仓库维护三个可直接安装的原创 Skill：[Document Quality Review](skills/document-quality-review/SKILL.md) 以只读方式检查交付物质量；[Skill Security Audit](skills/skill-security-audit/SKILL.md) 在安装前审查第三方 Skill、MCP 与扩展的权限、凭据、数据流和高风险动作；[Source-backed Research Brief](skills/source-backed-research-brief/SKILL.md) 将研究结论与来源、冲突和不确定性绑定。
