...
**43 curated repositories · 4 original Skills · 40 discovery candidates · weekly validation**
...
如果这个清单帮你节省了时间，欢迎点一个 ⭐；也欢迎通过 [Issue](https://github.com/sandbaseai/awesome-workbuddy/issues/new/choose) 推荐你验证过的资源。问题、想法和开放讨论请到 [Discussions](https://github.com/sandbaseai/awesome-workbuddy/discussions)；也可以直接参加 [欢迎与问答讨论](https://github.com/sandbaseai/awesome-workbuddy/discussions/78)。参与前请阅读 [社区行为准则](CODE_OF_CONDUCT.md)。
